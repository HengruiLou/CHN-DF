...
list_checkpoint = [torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_MESO4_AUDIO.pt')['state_dict'],
                   torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_MESO4_VIDEO.pt')['state_dict']]
