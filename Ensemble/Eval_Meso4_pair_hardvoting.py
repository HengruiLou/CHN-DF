...
####
test_dir =  ["/data/usr/lhr/FakeAVCeleb-main/Multimodal/Multimodal-2/CHN_DF_1W/FRAMS/test",
             "/data/usr/lhr/FakeAVCeleb-main/Multimodal/Multimodal-2/CHN_DF_1W/SPEC/test"]

list_test = [datasets.ImageFolder(root = test_dir[0],transform = None),
            datasets.ImageFolder(root = test_dir[1],transform = None)]
#print(list_test[0].targets.count(1))
...
print("list_targets_testpath_video",len(list_targets_testpath_video))
print("list_targets_testpath",len(list_targets_testpath))
...
list_checkpoint = [torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_MESO4_VIDEO.pt')['state_dict'],
                   torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_MESO4_AUDIO.pt')['state_dict']]
