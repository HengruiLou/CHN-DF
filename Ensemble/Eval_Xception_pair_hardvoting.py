...
list_checkpoint = [torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_XCEPTION_VIDEO.pt',map_location='cuda')['state_dict'],
                   torch.load(f'/data/usr/lhr/FakeAVCeleb-main/best_XCEPTION_AUDIO.pt',map_location='cuda')['state_dict']]
