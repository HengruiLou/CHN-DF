...
class DFDModel(BaseModel):
    ...
    def forward(self):
        ...
        '''
        print("-----------------self.aud_real.squeeze(0)------------------",self.aud_real.squeeze(0).shape)
        print("-----------------self.aud_real------------------",self.aud_real.shape)
        print("-----------------self.img_fake------------------",self.img_fake.shape)
        print("-----------------self.img_fake.squeeze(0)------------------",self.img_fake.squeeze(0).shape)
        '''
    ...
    def backward_G(self):
        ...
        #print("audio_real",audio_real.shape)
        video_real = self.img_real_feat
        #print("video_real",video_real.shape)
        video_fake = self.img_fake_feat
        #print("video_fake",video_fake.shape)
    ...
    #统一为[2048]
    def backward_G(self):
        audio_real = self.aud_real_feat.squeeze(0)
        #print("audio_real",audio_real.shape)
        video_real = self.img_real_feat.squeeze(0)
        #print("video_real",video_real.shape)
        video_fake = self.img_fake_feat
        #print("video_fake",video_fake.shape)
